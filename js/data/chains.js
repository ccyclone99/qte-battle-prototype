    ...
    nodes: [
      {
        ...
        duration: 0.55,
        input: { type: "press", key: "S" },
        pose: { state: "swordAttack", motion: "greatswordDraw" },
        window: { start: 0.18, end: 0.42 },
        perfect: 0.30,
      ...
      },
      {
        ...
        duration: 1.82,
        input: { type: "hold_release", key: "S" },
        pose: { state: "charge", motion: "greatswordCharge" },
        window: { start: 0.72, end: 1.48 },
        perfect: 1.08,
      ...
      },
      {
        ...
        duration: 0.55,
        input: { type: "press", key: "S" },
        pose: { state: "swordAttack", motion: "greatswordCleave" },
        window: { start: 0.18, end: 0.42 },
        perfect: 0.30,
      ...
      },
      {
        ...
        duration: 0.65,
        input: { type: "press", key: "S" },
        pose: { state: "swordAttack", motion: "greatswordEarthsplit" },
      ...
      },
      {
        ...
        duration: 0.5,
        input: { type: "press", key: "S" },
        pose: { state: "swordAttack", motion: "greatswordOvercharge" },
    ...
    nodes: [
      {
        ...
        duration: 0.42,
        input: { type: "press", key: "A" },
        pose: { state: "swordAttack", motion: "dualDash" },
      ...
      },
      {
        ...
        duration: 0.36,
        input: { type: "press", key: "A" },
        pose: { state: "swordAttack", motion: "dualFlurry" },
        window: { start: 0.12, end: 0.30 },
        perfect: 0.21,
      ...
      },
      {
        ...
        duration: 0.42,
        input: { type: "press", key: "D" },
        pose: { state: "swordAttack", motion: "dualFinisher" },
        window: { start: 0.15, end: 0.35 },
        perfect: 0.25,
      ...
      },
      {
        ...
        duration: 0.34,
        input: { type: "press", key: "A" },
        pose: { state: "swordAttack", motion: "dualRetreat" },
  ...
  staff_s: {
    ...
    nodes: [
      ...
      },
      {
        ...
        name: "吟唱",
        duration: 1.6,
        input: { type: "rhythm", key: "S", beats: [0.34, 0.72, 1.08, 1.42] },
        window: { start: 0, end: 1.6 },
        perfect: null,
  ...
  staff_d: {
    ...
    nodes: [
      ...
      },
      {
        ...
        name: "寒冰吟唱",
        duration: 1.28,
        input: { type: "rhythm", key: "D", beats: [0.32, 0.88] },
        window: { start: 0, end: 1.28 },
        perfect: null,
    ...
    nodes: [
      {
        ...
        duration: 0.55,
        input: { type: "press", key: "A" },
        pose: { state: "casting", motion: "fireKindle" },
        window: { start: 0.18, end: 0.42 },
        perfect: 0.30,
      ...
      },
      {
        ...
        duration: 1.35,
        input: { type: "hold_release", key: "A" },
        pose: { state: "charge", motion: "fireCharge" },
        window: { start: 0.45, end: 1.12 },
        perfect: 0.82,
      ...
      },
      {
        ...
        duration: 0.55,
        input: { type: "press", key: "A" },
        pose: { state: "casting", motion: "fireRelease" },
      ...
      },
      {
        ...
        duration: 0.4,
        input: { type: "press", key: "A" },
        pose: { state: "casting", motion: "fireSpark" },
      ...
      },
      {
        ...
        duration: 0.45,
        input: { type: "press", key: "A" },
        pose: { state: "charge", motion: "fireOverheat" },
        window: { start: 0.16, end: 0.34 },
        perfect: 0.25,
  ...
  absorb_siphon: {
    ...
    nodes: [
      ...
      },
      {
        ...
        name: "回流节奏",
        duration: 1.42,
        input: { type: "rhythm", key: "S", beats: [0.34, 0.76, 1.14] },
        pose: { state: "casting", motion: "absorbSiphon" },
        window: { start: 0, end: 1.42 },
        perfect: null,
        rhythmTolerance: 0.20,
    ...
    nodes: [
      {
        ...
        duration: 0.5,
        input: { type: "press", key: "A" },
        pose: { state: "charge", motion: "flameBladeIgnite" },
        window: { start: 0.16, end: 0.38 },
        perfect: 0.27,
      ...
      },
      {
        ...
        duration: 0.55,
        input: { type: "press", key: "A" },
        pose: { state: "swordAttack", motion: "flameBladeCut" },
        window: { start: 0.18, end: 0.42 },
        perfect: 0.30,
        onPerfect: { next: "burst", effect: "flame_blade_cut_perfect", damage: 22, chargeMul: 1.08, resource: { heat: 12 }, message: "熔甲入缝", status: { target: "enemy", type: "armorBreak", turns: 1 }, visualEvent: "fireBladeSlash" },
        onSuccess: { next: "burst", effect: "flame_blade_cut", damage: 16, chargeMul: 1.04, resource: { heat: 8 }, message: "焰刃压斩", visualEvent: "fireBladeSlash" },
      ...
      },
      {
        ...
        duration: 0.5,
        input: { type: "press", key: "D" },
        pose: { state: "swordAttack", motion: "flameBladeBurst" },
      ...
      },
      {
        ...
        duration: 0.4,
        input: { type: "press", key: "A" },
        pose: { state: "swordAttack", motion: "flameBladeEmber" },
    ...
    nodes: [
      {
        ...
        duration: 0.55,
        input: { type: "press", key: "F" },
        pose: { state: "shield", motion: "mirrorGuard" },
    ...
    nodes: [
      {
        ...
        pose: { state: "charge", motion: "overflowCompress" },
        window: { start: 0.20, end: 0.49 },
        perfect: 0.35,
      ...
      },
      {
        ...
        duration: 0.55,
        input: { type: "press", key: "D" },
        pose: { state: "casting", motion: "overflowBurst" },
        window: { start: 0.18, end: 0.42 },
        perfect: 0.30,
      ...
      },
      {
        ...
        duration: 0.45,
        input: { type: "press", key: "D" },
        pose: { state: "casting", motion: "overflowVent" },
        window: { start: 0.14, end: 0.34 },
        perfect: 0.24,
